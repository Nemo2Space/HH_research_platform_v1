...
# Find the exact spot and add after the ARM section
old_code = '''                    if st.button("DISARM", width='stretch', key="ai_pm_disarm_btn"):
                        disarm_auto_trade()
...
new_code = '''                    if st.button("DISARM", width='stretch', key="ai_pm_disarm_btn"):
                        disarm_auto_trade()
