...
# Replace the first build_target_weights call (around line 2707)
old_code1 = '''                # Get max holdings from session state (user-controlled slider)
                ...
                st.info(
                    f"🎯 **Strategy:** {get_strategy_key()} | **Max Holdings:** {max_holdings_override or 'default'} | **Targets:** {target_count}"'''
