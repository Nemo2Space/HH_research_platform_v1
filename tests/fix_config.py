...
class RiskConstraints:
    ...
    cash_min: float = -0.20               # -20% min cash (allows margin)
...
print("✅ Updated config.py with sensible defaults:")
print("   - max_sector_weight: 50% (was inconsistent)")
print("   - cash_min: -20% (allows margin)")
print("   - max_turnover_per_cycle: 100% (no limit)")
print("   - Added RELAXED_CONSTRAINTS option")
print("   - Added allow_gate_override flag")
